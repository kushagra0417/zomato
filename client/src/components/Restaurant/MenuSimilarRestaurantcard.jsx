           ...
           <div className="w-full h-48">
            <img src={props.image} alt="food" className="w-full h-full object-cover rounded-t-md" />   
             ...
             <div className="flex flex-col gap-2 p-3">
                 <h3 className=" my-1 font-semibold text-lg text-black">{props.title}</h3>
                 <div className="flex items-center text-sm justify-between">
                    ...
                    <span className="border-r  border-gray-500 w-2 h-6"/>
                    <span className="flex items-center gap-1">
                    <span className="flex items-center gap-1 bg-green-700 text-white px-2 py-1 rounded">
                        30
                       <TiStar/> 
                 ...
                 <h4>Pizza, Beverages, Fast Food, Desserts</h4>
             </div>
